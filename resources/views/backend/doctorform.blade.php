...
<div class="mb-3">
    ...
    <input value="{{old('user_name')}}" name="user_name" required type="text" class="form-control" id="exampleInputName1" aria-describedby="nameHelp">
   </div>

  <div class="mb-3">
    <label for="exampleInputEmail1" class="form-label">Email address</label>
    <input value="{{old('email_address')}}" name="email_address" type="text" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
   </div>

  <div class="mb-3">
    <label for="exampleInputPhonenumber1" class="form-label">Phone Number</label>
    <input value="{{old('phone_number')}}" required name="phone_number" type="text" class="form-control" id="exampleInputPhonenumber1">
  </div>
  ...
  <div class="mb-3">
    ...
    <input value="{{old('visiting_charge')}}" required name="visiting_charge" type="number" min="500" class="form-control" id="exampleInputCharge1">
  </div>
